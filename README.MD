...
| showRootNodeLabelLine | 是否显示左侧第一层的结构线，设置为 false 时只显示当前树和子树的层级引导线                                                                                                    | boolean |   -    | true   |
...
| expandIconWidth | 展开图标的宽度，用于控制层级引导线与展开图标的对齐位置。                                                                                                                    | number  |   -    | 24     |
...
$--element-tree-expand-icon-width: 24px;
@import 'element-tree-line/dist/style.scss';
```
